Vue.component('component-inscripcion',{
    ...
    methods:{
        validarCodigo(){
            ...
            const existe = alumnos.some((alumno)=> alumno.codigo === this.materia.codigoalumno);
            return existe;
            
        },
        guardarMateria(){
             if(this.accion==='validar'){
                const existe = this.validarCodigo();
                
                if (existe){
                    
                    alert('Materia inscrita con exito');
                    this.accion = 'nuevo';
                    ...
                    return alert('codigo de estudiante invalido, ingrese su codigo de matricula');
                ...
                <div class="card" style="margin-top: 40px">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-3 col-md-3">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-3">
                                    <input @click.prevent="accion = 'validar'; guardarMateria()" class="btn btn-primary" type="submit" 
