        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="card" style="margin-top: 40px;">
                    <div class="card-header">MATRICULA DE ALUMNO</div>
                    <div class="card-body">
                        ...
                        <div class="col-3 col-md-3">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtNombreAlumno">NOMBRE COMPLETO:</label>
                                </div>
                            ...
                            <div class="row p-1">
                                ...
                                <div class="col-3 col-md-3">
                                    <input class="btn btn-warning" type="reset" value="NUEVA MATRICULA">
                                </div>
                            </div>
                        </form>
                    </div>
