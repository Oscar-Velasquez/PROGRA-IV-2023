        ...
        if( $this->respuesta['msg']=='ok' ){
            if($accion=='nuevo'){
                return $this->db->consultas(
                    ...
                    $this->datos['idAlumno'], $this->datos['codigo'], $this->datos['nombre'], $this->datos['direccion'], $this->datos['telefono'], $this->datos['dui']
                );
            }else if($accion=='modificar'){
                return $this->db->consultas(
                    'UPDATE alumnos SET codigo=?, nombre=?, direccion=?, telefono=?, dui=? WHERE idAlumno=?',
                    $this->datos['codigo'], $this->datos['nombre'], $this->datos['direccion'], $this->datos['telefono'], $this->datos['dui'], $this->datos['idAlumno']
                );
