                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="frmInscripcion" @reset.prevent="nuevoInscripcion" v-on:submit.prevent="guardarInscripcion">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtCodigoInscripcion">Materia I:</label>
                                </div>
                                <div class="col-3 col-md-6">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtCodigoInscripcion">Materia II:</label>
                                </div>
                                <div class="col-3 col-md-6">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtCodigoInscripcion">Materia III:</label>
                                </div>
                                <div class="col-3 col-md-6">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtCodigoInscripcion">Materia IV:</label>
                                </div>
                                <div class="col-3 col-md-6">
                            ...
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                                    <label for="txtCodigoInscripcion">Materia V:</label>
                                </div>
                                <div class="col-3 col-md-6">
